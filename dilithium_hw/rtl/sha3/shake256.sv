...
// Module:      shake256_absorb_once / shake256_squeezeblocks
// Description: SHAKE256 extendable-output function (FIPS 202).
//
//              Same structure as shake128.sv but with rate = 136 bytes.
//              Used by Dilithium for key generation (expansion of seeds)
//              and for sampling secret polynomials.
//
...
`ifndef DILITHIUM_SHAKE256_SV
`define DILITHIUM_SHAKE256_SV
...
module shake256_squeezeblocks #(
    ...
    output logic                    done,
    output logic [7:0]              out_data [MAX_BLOCKS*136],
    output logic                    err
);
